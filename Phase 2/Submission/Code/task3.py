...
from similarity import similarityOption2
from dwt import similarityMatrixDTW
from editDistance import similarityMatrixForED
from dotProduct import similarityMatrixForDP
from vectorModels import svd, nmf
...
def process_input(user_option, vector_model, p, semantic_features, vector_model2):
    if user_option == 1:
...
def main():
    ...
    p = int(input("Enter the number of components(p): "))
    ...
    print("Choose one of the vector model from the following: \n1. TF \n2. TF-IDF")
    vector_model2 = input("Choose 1 - 2: ")
    process_input(user_option, vector_model, p, semantic_features, vector_model2)
