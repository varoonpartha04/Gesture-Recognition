...
import numpy as np
from phase2_task3 import process_input
...
def main():
    k = int(input("Enter the no of output edges to create for each gesture(k): ")) # no of components
    n = int(input("Enter the no of input gestures: ")) # different user specified inputs
    m = int(input("Enter the no of dominant gestures: ")) # m -> no of most dominant gestures
    query_gestures = []
    for i in range(n):
